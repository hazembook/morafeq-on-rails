...
namespace :demo do
  desc "Seed development/demo data (users, colleges, subjects, posts, etc.)"
  task seed: :environment do
    abort("Demo seed is only allowed in development, test, and demo environments.") unless Rails.env.development? || Rails.env.test? || Rails.env.demo?
