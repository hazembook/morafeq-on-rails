class QuizzesController < ApplicationController
  ...
  def new
    ...
    3.times { @quiz.quiz_questions.build }
  end
  ...
  def quiz_params
    params.require(:quiz).permit(:title, :due_at, quiz_questions_attributes: [ :id, :question, :points, :question_type, :choices_text, :_destroy ])
  end
end
